...
function EmailButton() {
  return (
    <Button href="mailto:onestepaheadculvercity@gmail.com">
      ...
      <span id="EmailButton__text-short">Here</span>
    </Button>
  );
}
    ...
    <main id="Contact">
      ...
      <div id="Contact__grid">
        <div id="Contact__info">
          ...
          <div>
            If your child is participating in the program,{" "}
            <strong>please regularly check your inbox or text messages</strong>.
            Our mentors need to be able to reach you to check in, schedule
            meetings, and announce any unexpected circumstances. Thank you for
            your cooperation!
            <br />
            <br />
