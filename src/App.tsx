  ...
  return (
    <footer className="Landing__footer">
      <div id="footer-location">
        ...
        <table id="footer-location-about-desktop" cellSpacing="0">
          <tbody>
            ...
            <tr>
              <td>
                Culver City High School &mdash; 4401 Elenda Street, Culver City,
                CA 90230
              </td>
        ...
        <div id="footer-location-quote">
          Email Us At:{" "}
          <a href="mailto:onestepaheadculvercity@gmail.com">
      ...
      <div id="footer-credits">
        <span id="copyright">
          {new Date().getFullYear()} Mateo Rodriguez Web Development, All Rights
          Reserved.
        </span>
      </div>
    </footer>
